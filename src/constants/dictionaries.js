    ...
    // -------------------------
    {
        ...
        items: [
            ...
            { 
                label: 'Типи посилок', 
                path: 'parcel-types', 
                endpoint: 'parcel-types', 
                columns: DEFAULT_COLS 
            },
            { 
                label: 'Типи відправлень', 
                path: 'shipment-types', 
                endpoint: 'shipment-types', 
                columns: DEFAULT_COLS 
            },
            { 
                label: 'Статуси вантажу', 
